...
feature_replicate_correlation <- function(df, 
                                          grouping_cols, 
                                          feature_col, 
                                          key_col) {
  ...
  futile.logger::flog.info(paste("correlation matrix headers", 
                                 paste(colnames(correlation_matrix), collapse = ","), 
                                 sep = ":"))
...
df %>%
  ...
  purrr::map_df(feature_replicate_correlation, 
